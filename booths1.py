...
def calculate():
	...
	T = Text(root, height=800, width=150)
	T.place(x=10,y=130)
	a=t1.get()
	b=t2.get()
	z=t3.get()
...
def printResult(a,z):
	...
	resu="The result in decimal form is "+str(value)
	Label(root,text=resu,fg="red",font='times 20',bg='white').place(x=30,y=150)

def boothMultiplication():
	a=t1.get()
	b=t2.get()
	z=t3.get()
	a=int(a)
	...
	z=int(z)
	c = (multiply(a,b,z))
	resu="The Result in binary form is "+c
	Label(root,text=resu,fg="red",font='times 20',bg='white').place(x=0,y=120)
	printResult(c,z)
...
b1=Button(root,text="Calculate",font='times 15',command=boothMultiplication)
b3=Button(root,text="Show Calculations",font='times 15',command=calculate)
